...
public class NewsDao {
	 ...
	 * @throws SQLException
	 */
	public static  void save(News news, String dbName) throws SQLException{
		Connection conn = DBConnection.getConnection();
		String sql = "INSERT INTO " + dbName + " (classifyid,sourceid,docid,title,content,commentnum,scannum,ptime) VALUES (?,?,?,?,?,?,?,?)";
	 ...
	 * @throws SQLException
	 */
	public static void saveTrainingData(News news) throws SQLException{
		save(news, "news");
	}
	 ...
	 * @throws SQLException
	 */
	public static void saveTestData(News news) throws SQLException{
		save(news, "testnews");
	}
	 ...
	 * @throws SQLException
	 */
	public static List<News> queryAllTestNews() throws SQLException{
		List<News> list = new ArrayList<News>();
		String sql = "select * from testnews";
		list = query(sql);
		System.out.println("queryAllTestNews OK");
		return list;
	}
}
